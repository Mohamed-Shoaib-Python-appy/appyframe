...
function can_subscribe_doctype(args) {
	...
	frappe_request("/api/method/appyframe.realtime.can_subscribe_doctype", args.socket)
		.type("form")
		.query({
...
function can_subscribe_doc(args) {
	...
	frappe_request("/api/method/appyframe.realtime.can_subscribe_doc", args.socket)
		.type("form")
		.query({
			doctype: args.doctype,
			docname: args.docname,
