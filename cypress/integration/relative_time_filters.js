...
// 		cy.window().its('appyframe').then(appyframe => {
// 			appyframe.call("appyframe.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/appyframe.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/appyframe.model.utils.user_settings.save')
