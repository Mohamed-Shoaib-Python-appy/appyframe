...
context("Sidebar", () => {
	before(() => {
		...
		return cy
			...
			.its("appyframe")
			.then((appyframe) => {
				return appyframe.call("appyframe.tests.ui_test_helpers.create_blog_post");
			});
	});

	it("Verify attachment visibility config", () => {
		cy.call("appyframe.tests.ui_test_helpers.create_todo", {
	...
	it("Verify attachment accessibility UX", () => {
		cy.call("appyframe.tests.ui_test_helpers.create_todo_with_attachment_limit", {
