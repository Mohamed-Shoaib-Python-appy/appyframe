...
class TestWorkspace(FrappeTestCase):
	...
	def tearDown(self):
		appyframe.db.delete("Workspace", {"module": "Test Module"})
		appyframe.db.delete("DocType", {"module": "Test Module"})
		appyframe.delete_doc("Module Def", "Test Module")
	...
	# 	if appyframe.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = appyframe.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "appyframe"})
...
def create_workspace(**args):
	workspace = appyframe.new_doc("Workspace")
