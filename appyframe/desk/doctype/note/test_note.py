# Copyright (c) 2015, Appyframe Technologies Pvt. Ltd. and Contributors and Contributors
# License: MIT. See LICENSE

import appyframe
from appyframe.tests.utils import FrappeTestCase

test_records = appyframe.get_test_records("Note")


class TestNote(FrappeTestCase):
	def insert_note(self):
		appyframe.db.delete("Version")
		appyframe.db.delete("Note")
		appyframe.db.delete("Note Seen By")

		return appyframe.get_doc(dict(doctype="Note", title="test note", content="test note content")).insert()
	...
	def test_version(self):
		...
		version = appyframe.get_doc("Version", dict(docname=note.name))
