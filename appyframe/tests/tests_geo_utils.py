...
import appyframe
from appyframe.geo.utils import get_coords
from appyframe.tests.utils import FrappeTestCase


class TestGeoUtils(FrappeTestCase):
	def setUp(self):
		self.todo = appyframe.get_doc(
		...
		self.test_location = appyframe.get_doc(
	...
	def test_get_coords_from_not_existable_location(self):
		self.assertRaises(appyframe.ValidationError, get_coords, "ToDo", self.test_filter_todo, "location_field")

	def test_get_coords_from_not_existable_coords(self):
		self.assertRaises(appyframe.ValidationError, get_coords, "ToDo", self.test_filter_todo, "coordinates")
