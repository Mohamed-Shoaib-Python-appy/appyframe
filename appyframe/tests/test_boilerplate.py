...
import appyframe
from appyframe.modules.patch_handler import get_all_patches, parse_as_configfile
from appyframe.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = appyframe._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.default_user_input = appyframe._dict(
			{
				"title": "Test App",
		...
		cls.bench_path = appyframe.utils.get_bench_path()
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(appyframe.get_app_path("appyframe", "patches.txt")))
		...
		expected_patch = "appyframe.core.doctype.user.patches.delete_all_users"
