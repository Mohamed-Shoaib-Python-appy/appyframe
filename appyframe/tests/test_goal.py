...
from appyframe.utils import format_date, today
from appyframe.utils.goal import get_monthly_goal_graph_data, get_monthly_results
...
class TestGoal(FrappeTestCase):
	...
	def test_get_monthly_goal_graph_data(self):
		...
		docname = appyframe.get_list("Event", filters={"subject": ["=", "_Test Event 1"]})[0]["name"]
		appyframe.db.set_value("Event", docname, "description", 1)
