...
import appyframe
import appyframe.desk.form.document_follow as document_follow
from appyframe.desk.form.assign_to import add
from appyframe.desk.form.document_follow import get_document_followed_by_user
from appyframe.desk.form.utils import add_comment
from appyframe.desk.like import toggle_like
from appyframe.query_builder import DocType
from appyframe.query_builder.functions import Cast_
from appyframe.share import add as share
...
class TestDocumentFollow(FrappeTestCase):
	...
	def tearDown(self):
		...
		appyframe.db.delete("Document Follow")
	...
	doc = appyframe.get_doc(
		{
			...
			"doc.starts_on": appyframe.utils.now(),
			"doc.ends_on": appyframe.utils.add_days(appyframe.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if appyframe.db.exists("User", "test@docsub.com"):
		doc = appyframe.delete_doc("User", "test@docsub.com")
	doc = appyframe.new_doc("User")
