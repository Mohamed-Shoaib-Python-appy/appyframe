...
import appyframe
from appyframe import safe_decode
from appyframe.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from appyframe.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from appyframe.email.receive import Email
...
<div>
	...
	<img embed="assets/appyframe/images/appyframe-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/appyframe/images/appyframe-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = appyframe.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="appyframe-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/appyframe/images/appyframe-favicon.svg" alt="test" />
