...
from appyframe.utils import get_bench_path, get_site_path
from appyframe.utils.file_lock import LockTimeoutError
...
def filelock(lock_name: str, *, timeout=30, is_global=False):
	...
	try:
		...
		appyframe.log_error("Filelock: Failed to aquire {lock_path}")
