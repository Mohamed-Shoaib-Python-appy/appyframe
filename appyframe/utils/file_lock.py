...
Use `appyframe.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import appyframe
from appyframe.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in appyframe.local.locked_documents:
		doc.unlock()
