...
from appyframe.utils import add_to_date, get_datetime, getdate
...
def get_user_date_format():
	if getattr(appyframe.local, "user_date_format", None) is None:
		appyframe.local.user_date_format = appyframe.defaults.get_global_default("date_format") or "yyyy-mm-dd"

	return appyframe.local.user_date_format
...
def datetime_in_user_format(date_time):
	...
	from appyframe.utils import formatdate
