...
import appyframe
from appyframe.model.document import Document, bulk_insert
...
def get_countries_and_currencies():
	from appyframe.geo.country_info import get_all as get_geo_data
	...
	for name, country in data.items():
		country = appyframe._dict(country)
		countries.append(
			appyframe.get_doc(
				doctype="Country",
				name=name,
