...
def get_documents():
	...
	docs.append(
		{
			...
			Appyframe Technologies Pvt. Ltd. and is built on MariaDB database system using a Python based server-side framework.
	...
	docs.append(
		{
			"name": "sw/appyframe",
			"content": """Appyframe Framework is a full-stack web framework, that includes everything you need to build and
