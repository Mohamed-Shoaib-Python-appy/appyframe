...
import appyframe
from appyframe.utils import get_request_session
...
def make_request(method, url, auth=None, headers=None, data=None, json=None, params=None):
	...
	try:
		...
		response = appyframe.flags.integration_request = s.request(
...
def create_request_log(
	...
	**kwargs,
	...
	integration_request = appyframe.get_doc(
		{
...
def get_json(obj):
	return obj if isinstance(obj, str) else appyframe.as_json(obj, indent=1)
