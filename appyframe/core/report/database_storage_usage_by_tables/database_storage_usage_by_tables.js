...
appyframe.query_reports["Database Storage Usage By Tables"] = {
	filters: [],
			...
			function () {
				let d = new appyframe.ui.Dialog({
					...
					primary_action(values) {
						appyframe.call({
							method: "appyframe.core.report.database_storage_usage_by_tables.database_storage_usage_by_tables.optimize_doctype",
							args: {
