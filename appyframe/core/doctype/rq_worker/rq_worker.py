...
from appyframe.utils import cint, convert_utc_to_system_timezone
from appyframe.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> appyframe._dict:
	...
	if current_job and not current_job.startswith(appyframe.local.site):
		current_job = None
