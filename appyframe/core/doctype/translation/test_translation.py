...
class TestTranslation(FrappeTestCase):
	def setUp(self):
		appyframe.db.delete("Translation")

	def tearDown(self):
		appyframe.local.lang = "en"
		from appyframe.translate import clear_cache
	...
	def test_doctype(self):
		...
		for lang, (source_string, new_translation) in translation_data.items():
			...
			appyframe.delete_doc("Translation", docname)
