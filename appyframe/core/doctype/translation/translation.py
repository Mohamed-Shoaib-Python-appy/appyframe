...
from appyframe.translate import MERGED_TRANSLATION_KEY, USER_TRANSLATION_KEY
...
def clear_user_translation_cache(lang):
	appyframe.cache.hdel(USER_TRANSLATION_KEY, lang)
	appyframe.cache.hdel(MERGED_TRANSLATION_KEY, lang)
