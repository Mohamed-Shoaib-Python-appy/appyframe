...
def execute():
	...
	reports = appyframe.get_all("Report", {"report_type": "Report Builder"})

	for report_name in reports:
		settings = appyframe.db.get_value("Report", report_name, "json")
		if not settings:
			continue

		settings = appyframe._dict(json.loads(settings))
		...
		appyframe.db.set_value("Report", report_name, "json", json.dumps(settings))
