...
def execute():
	appyframe.reload_doc("core", "doctype", "docfield", force=True)
	appyframe.reload_doc("custom", "doctype", "custom_field", force=True)
	appyframe.reload_doc("custom", "doctype", "customize_form_field", force=True)
	appyframe.reload_doc("custom", "doctype", "property_setter", force=True)
