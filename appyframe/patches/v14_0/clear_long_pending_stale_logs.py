import appyframe
from appyframe.core.doctype.log_settings.log_settings import clear_log_table
from appyframe.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/appyframe/appyframe/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(appyframe.db.exists(doctype, {"modified": ("<", threshold)}))


def get_current_setting(fieldname):
	try:
		return appyframe.db.get_single_value("Log Settings", fieldname)
	except Exception:
