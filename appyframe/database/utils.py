...
from appyframe.query_builder.functions import Function
...
class LazyMogrify(LazyString):
	...
	def _setup(self) -> str:
		return appyframe.db.mogrify(self.query, self.values)
...
def dangerously_reconnect_on_connection_abort(func):
	...
	def wrapper(*args, **kwargs):
		try:
			...
			if appyframe.db.is_interface_error(e) or isinstance(e, appyframe.db.OperationalError):
