...
class DbManager:
	...
	def restore_database(verbose: bool, target: str, source: str, user: str, password: str) -> None:
		...
		from appyframe.utils import execute_in_shell
		...
		appyframe.cache.delete_keys("")  # Delete all keys associated with this site.
