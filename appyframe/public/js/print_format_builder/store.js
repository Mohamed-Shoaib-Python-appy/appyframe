...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			appyframe.model.clear_doc("Print Format", print_format_name);
			appyframe.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = appyframe.get_doc("Print Format", print_format_name);
				appyframe.model.with_doctype(_print_format.doc_type, () => {
					meta.value = appyframe.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return appyframe.db.get_doc("Letter Head", _letterhead).then((doc) => {
