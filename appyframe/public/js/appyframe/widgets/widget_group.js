...
appyframe.provide("appyframe.widget");

appyframe.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
appyframe.widget.make_widget = (opts) => {
	const widget_class = appyframe.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = appyframe.widget.make_widget({
			...widget,
...
appyframe.widget.WidgetGroup = WidgetGroup;
appyframe.widget.SingleWidgetGroup = SingleWidgetGroup;
