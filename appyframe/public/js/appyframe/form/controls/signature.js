appyframe.ui.form.ControlSignature = class ControlSignature extends appyframe.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		appyframe.require("/assets/appyframe/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${appyframe.utils.icon("restriction", "md")}</i>
