appyframe.ui.form.ControlMarkdownEditor = class ControlMarkdownEditor extends (
	appyframe.ui.form.ControlCode
) {
	...
	update_preview() {
		...
		this.markdown_preview.html(appyframe.markdown(value));
	}
