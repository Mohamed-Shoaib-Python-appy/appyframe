...
appyframe.ui.form.ControlComment = class ControlComment extends appyframe.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${appyframe.avatar(appyframe.session.user, "avatar-medium")}
					<div class="appyframe-control col"></div>
				</div>
		...
		`)
			: $('<div class="appyframe-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to appyframe-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".appyframe-control")
