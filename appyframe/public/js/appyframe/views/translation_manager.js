appyframe.views.TranslationManager = class TranslationManager {
	constructor(opts) {
	...
	get_translations_data() {
		return appyframe.db.get_list("Translation", {
	...
	update_translations({ source, translation_data = [] }) {
		...
		return appyframe
			.call({
				method: "appyframe.translate.update_translations_for_source",
